 ...
 */
@KiWiFacade
@RDFType(Constants.NS_INTEREDU_CORE + "Kategorie")
public interface InterEduKategorieFacade extends ContentItemI {
	
	@RDF(Constants.NS_INTEREDU_CORE+"kategorieId")
	public int getKategorieId();
	
	public void setKategorieId(int id);
	
	@RDF(Constants.NS_INTEREDU_CORE+"kategorieName")
	public String getKategorieName();
	
	public void setKategorieName(String name);
	
	@RDF(Constants.NS_INTEREDU_CORE+"kategorieParentId")
