function vmt(){
  ...
  $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('vmt');
      ...
      vmt = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'vmt', base);
      $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }

  function computeScriptBase(){
    var thisScript, markerId = '__gwt_marker_vmt', markerScript;
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  ;
  vmt.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  computeScriptBase();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('vmt'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?vmt';
    strongName = '';
  }
  processMetas();
  $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['ie8'], '21EBBBBDA8D01079894DDF0CD4BA181B');
      unflattenKeylistIntoAnswers(['ie6'], '4B33450F83AB9720DDA72B6C4EA373F9');
      unflattenKeylistIntoAnswers(['gecko1_8'], '59E835A11F12C2DAC98700B35889CFAB');
      unflattenKeylistIntoAnswers(['safari'], '71FB9A4C1F8E8FFCA7EAF906AA429920');
      unflattenKeylistIntoAnswers(['opera'], 'D0C2052D8CBF400F0184362FE9B9B47E');
      unflattenKeylistIntoAnswers(['gecko'], 'E468AFC61CFBFC687DEB712D0B866737');
  ...
  , 50);
  $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'vmt', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  if (!__gwt_scriptsLoaded['sc/skins/Graphite/load_skin.js']) {
    __gwt_scriptsLoaded['sc/skins/Graphite/load_skin.js'] = true;
    document.write('<script language="javascript" src="' + base + 'sc/skins/Graphite/load_skin.js"><\/script>');
  }
  $doc_0.write('<script defer="defer">vmt.onInjectionDone(\'vmt\')<\/script>');
}
