...
final class ApplicationsParser {
    ...
    /**
     * The ear module name prefix characteristic to a kiwi
     * extension.
     */
    ...
    /**
     * All the kiwi extension names - and them state, if the
     * state flag is false then the kiwi extension will be
     * removed on the next persist action.
     */
    ...
    ApplicationsParser(Document document) {
        ...
        applicationNodes =
                getApplications(document, KIWI_EXTENSION_NAME_PREFIX);
    ...
    /**
     * Extracts all the ejb nodes which have a text content that
     * start with the given prefix. If this method return null
     * then the provided DOM does not contains any EJB KiWi
     * related nodes.
     * 
     * @param document the DOM to serch.
     * @param moduleNamePrefix the prefix for the node text
     *            content.
    ...
    /**
     * Returns an alphabetic sorted list which contains all the
     * KiWi extension names, if the list is empty then the system
     * does not contains any KiWi related application.
     * 
     * @return an alphabetic sorted list which contains all the
     *         KiWi extension names.
     */
