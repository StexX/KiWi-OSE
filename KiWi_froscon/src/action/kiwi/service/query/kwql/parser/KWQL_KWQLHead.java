...
// $ANTLR 3.1.3 Mar 17, 2009 19:23:44 KWQLHead.g 2010-04-19 10:33:19
...
public class KWQL_KWQLHead extends Parser {
    ...
    public KWQL gParent;
        ...
        public KWQL_KWQLHead(TokenStream input, KWQL gKWQL) {
            this(input, new RecognizerSharedState(), gKWQL);
        }
        public KWQL_KWQLHead(TokenStream input, RecognizerSharedState state, KWQL gKWQL) {
            super(input, state);
            this.gKWQL = gKWQL;
    ...
    public final KWQL_KWQLHead.head_return head() throws RecognitionException {
        KWQL_KWQLHead.head_return retval = new KWQL_KWQLHead.head_return();
        retval.start = input.LT(1);

        CommonTree root_0 = null;

        KWQL_KWQLHead.c_resource_term_return c_resource_term1 = null;

        KWQL_KWQLHead.q_c_resource_term_return q_c_resource_term2 = null;
    ...
    public final KWQL_KWQLHead.cvalue_return cvalue() throws RecognitionException {
        KWQL_KWQLHead.cvalue_return retval = new KWQL_KWQLHead.cvalue_return();
        retval.start = input.LT(1);

        CommonTree root_0 = null;

        Token VARIABLE3=null;
        KWQL_KWQLBody.atomar_value_return atomar_value4 = null;

        KWQL_KWQLHead.q_cvalue_return q_cvalue5 = null;
        ...
        try {
            ...
            switch (alt2) {
                ...
                case 2 :
                    ...
                    atomar_value4=gKWQL.atomar_value();
    ...
    public final KWQL_KWQLHead.resource_return resource() throws RecognitionException {
        KWQL_KWQLHead.resource_return retval = new KWQL_KWQLHead.resource_return();
        retval.start = input.LT(1);
    ...
    public final KWQL_KWQLHead.c_resource_term_return c_resource_term() throws RecognitionException {
        KWQL_KWQLHead.c_resource_term_return retval = new KWQL_KWQLHead.c_resource_term_return();
        retval.start = input.LT(1);
        ...
        KWQL_KWQLHead.resource_return resource7 = null;

        KWQL_KWQLHead.c_resource_content_return c_resource_content9 = null;
    ...
    public final KWQL_KWQLHead.c_resource_content_return c_resource_content() throws RecognitionException {
        KWQL_KWQLHead.c_resource_content_return retval = new KWQL_KWQLHead.c_resource_content_return();
        retval.start = input.LT(1);

        CommonTree root_0 = null;

        KWQL_KWQLHead.c_resource_content_helper_return c = null;

        KWQL_KWQLHead.c_resource_content_helper_return c_resource_content_helper11 = null;

        KWQL_KWQLHead.conjunction_return conjunction12 = null;

        KWQL_KWQLHead.q_c_resource_content_return q_c_resource_content13 = null;
                ...
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    // AST REWRITE
                    	    // elements: c, c_resource_content, conjunction
                    	    // token labels: 
    ...
    public final KWQL_KWQLHead.conjunction_return conjunction() throws RecognitionException {
        KWQL_KWQLHead.conjunction_return retval = new KWQL_KWQLHead.conjunction_return();
        retval.start = input.LT(1);
    ...
    public final KWQL_KWQLHead.c_resource_content_helper_return c_resource_content_helper() throws RecognitionException {
        KWQL_KWQLHead.c_resource_content_helper_return retval = new KWQL_KWQLHead.c_resource_content_helper_return();
        retval.start = input.LT(1);

        CommonTree root_0 = null;

        KWQL_KWQLHead.c_qualifier_return c_qualifier15 = null;

        KWQL_KWQLHead.c_resource_term_return c_resource_term16 = null;
    ...
    public final KWQL_KWQLHead.c_qualifier_return c_qualifier() throws RecognitionException {
        KWQL_KWQLHead.c_qualifier_return retval = new KWQL_KWQLHead.c_qualifier_return();
        retval.start = input.LT(1);

        CommonTree root_0 = null;

        Token QUAL17=null;
        KWQL_KWQLHead.cvalue_return cvalue18 = null;

        KWQL_KWQLHead.q_c_qualifier_return q_c_qualifier19 = null;
    ...
    public final KWQL_KWQLHead.q_c_resource_term_return q_c_resource_term() throws RecognitionException {
        KWQL_KWQLHead.q_c_resource_term_return retval = new KWQL_KWQLHead.q_c_resource_term_return();
        retval.start = input.LT(1);
        ...
        KWQL_KWQLHead.c_resource_term_return c_resource_term22 = null;


        CommonTree UQ20_tree=null;
        ...
        try {
            ...
            {
            UQ20=(Token)match(input,UQ,FOLLOW_UQ_in_q_c_resource_term390); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_UQ.add(UQ20);

            LEFT_PARENTHESIS21=(Token)match(input,LEFT_PARENTHESIS,FOLLOW_LEFT_PARENTHESIS_in_q_c_resource_term392); if (state.failed) return retval; 
            ...
            c_resource_term22=c_resource_term();

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_c_resource_term.add(c_resource_term22.getTree());
            RIGHT_PARENTHESIS23=(Token)match(input,RIGHT_PARENTHESIS,FOLLOW_RIGHT_PARENTHESIS_in_q_c_resource_term396); if (state.failed) return retval; 
    ...
    public final KWQL_KWQLHead.q_c_qualifier_return q_c_qualifier() throws RecognitionException {
        KWQL_KWQLHead.q_c_qualifier_return retval = new KWQL_KWQLHead.q_c_qualifier_return();
        retval.start = input.LT(1);
        ...
        KWQL_KWQLHead.c_qualifier_return c_qualifier26 = null;
        ...
        try {
            ...
            {
            UQ24=(Token)match(input,UQ,FOLLOW_UQ_in_q_c_qualifier414); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_UQ.add(UQ24);

            LEFT_PARENTHESIS25=(Token)match(input,LEFT_PARENTHESIS,FOLLOW_LEFT_PARENTHESIS_in_q_c_qualifier416); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_LEFT_PARENTHESIS.add(LEFT_PARENTHESIS25);

            pushFollow(FOLLOW_c_qualifier_in_q_c_qualifier418);
            c_qualifier26=c_qualifier();

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_c_qualifier.add(c_qualifier26.getTree());
            RIGHT_PARENTHESIS27=(Token)match(input,RIGHT_PARENTHESIS,FOLLOW_RIGHT_PARENTHESIS_in_q_c_qualifier420); if (state.failed) return retval; 
    ...
    public final KWQL_KWQLHead.q_c_resource_content_return q_c_resource_content() throws RecognitionException {
        KWQL_KWQLHead.q_c_resource_content_return retval = new KWQL_KWQLHead.q_c_resource_content_return();
        retval.start = input.LT(1);
        ...
        KWQL_KWQLHead.c_resource_content_return c_resource_content30 = null;
        ...
        try {
            ...
            {
            UQ28=(Token)match(input,UQ,FOLLOW_UQ_in_q_c_resource_content438); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_UQ.add(UQ28);

            LEFT_PARENTHESIS29=(Token)match(input,LEFT_PARENTHESIS,FOLLOW_LEFT_PARENTHESIS_in_q_c_resource_content440); if (state.failed) return retval; 
            ...
            c_resource_content30=c_resource_content();

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_c_resource_content.add(c_resource_content30.getTree());
            RIGHT_PARENTHESIS31=(Token)match(input,RIGHT_PARENTHESIS,FOLLOW_RIGHT_PARENTHESIS_in_q_c_resource_content444); if (state.failed) return retval; 
    ...
    public final KWQL_KWQLHead.q_cvalue_return q_cvalue() throws RecognitionException {
        KWQL_KWQLHead.q_cvalue_return retval = new KWQL_KWQLHead.q_cvalue_return();
        retval.start = input.LT(1);
        ...
        KWQL_KWQLHead.cvalue_return cvalue34 = null;
        ...
        try {
            ...
            {
            UQ32=(Token)match(input,UQ,FOLLOW_UQ_in_q_cvalue460); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_UQ.add(UQ32);

            LEFT_PARENTHESIS33=(Token)match(input,LEFT_PARENTHESIS,FOLLOW_LEFT_PARENTHESIS_in_q_cvalue462); if (state.failed) return retval; 
            ...
            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) stream_cvalue.add(cvalue34.getTree());
            RIGHT_PARENTHESIS35=(Token)match(input,RIGHT_PARENTHESIS,FOLLOW_RIGHT_PARENTHESIS_in_q_cvalue466); if (state.failed) return retval; 
