 ...
 */
@KiWiFacade
@RDFType( {Constants.NS_ROUTEIT + "TrackPoint"})
public interface TrackPointFacade extends ContentItemI,Serializable {
    ...
    /**
     * Used to include this point in a ordinated collection.
     * 
     * @return the ordinal for this point.
     */
    @RDF(Constants.NS_ROUTEIT + "oridinal")
    int getOrdinal();
