...
package kiwi.action.revision.style;
 ...
 *
 */
@Name("kiwi.action.revision.style.styleCreator")
@Scope(ScopeType.PAGE) // event scoped so that it is rerendered when the page is displayed again
public class StyleCreator implements Serializable {
	...
	@DataModel(value="kiwi.action.revision.style.colourLegend",scope=ScopeType.PAGE)
