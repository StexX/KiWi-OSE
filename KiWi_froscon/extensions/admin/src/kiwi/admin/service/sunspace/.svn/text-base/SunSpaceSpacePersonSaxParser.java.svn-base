...
import kiwi.model.ceq.SunSpaceImportSpacePerson;
 ...
 * @since 0.9
 */
final class SunSpaceSpacePersonSaxParser extends DefaultHandler {
     ...
     */
    private SunSpaceImportSpacePerson spacePerson;
    ...
    private final StringBuilder roleAdminBuffer;
     ...
     */
    SunSpaceSpacePersonSaxParser(final EntityManager entityManager, 
        ...
        roleAdminBuffer = new StringBuilder();
    }
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if ("row".equals(qName)) {
            spacePerson = new SunSpaceImportSpacePerson();
            inRow = true;
            property = null;
        }
...
// spacePerson.setSpaceId(Long.valueOf(value));
                spaceIdBuffer.append(value);
            } else if ("PERSON_ID".equals(property)) {
// spacePerson.setPersonId(Long.valueOf(value));
                personIdBuffer.append(value);
            } else if ("ROLE_ADMIN".equals(property)) {
// spacePerson.setRole(Integer.valueOf(value));
                roleAdminBuffer.append(value);
            }
        }
    }
     ...
     * 
     * @see SunSpaceImportSpacePerson
     */
    private void store() {

        final String spaceId = spaceIdBuffer.toString();
        spacePerson.setSpaceId(Long.valueOf(spaceId));

        final String personId = personIdBuffer.toString();
        spacePerson.setPersonId(Long.valueOf(personId));

        final String role = roleAdminBuffer.toString();
        spacePerson.setRole(Integer.valueOf(role));
    }

    private void cleanBuffers() {
        spaceIdBuffer.delete(0, spaceIdBuffer.length());
        personIdBuffer.delete(0, personIdBuffer.length());
        roleAdminBuffer.delete(0, roleAdminBuffer.length());
    }
    ...
    public void endElement(String uri, String localName, String qName)
        ...
        try {
            if ("row".equals(qName)) {
                ...
                entityManager.persist(spacePerson);
...
//                    entityManager.flush();
                ...
                message.append(" SunSpaceImportSpacePerson items was imported.");
            ...
            // trans. works or not.
            logger.warn("The #0 can not be imported", spacePerson);
