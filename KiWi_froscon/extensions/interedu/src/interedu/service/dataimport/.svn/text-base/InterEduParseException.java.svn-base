...
/**
 * Indicates a error during the parsing process InterEdu
 * documents.<br>
 ...
 * @since 03-pre
 */
public class InterEduParseException extends Exception {
     ...
     */
    private static final long serialVersionUID = -8349864092988716790L;

    /**
     * Constructs an <code>InterEduParseException</code> without
     * a detail message or a specified cause.
     */
    InterEduParseException() {
        super();
    }

    /**
     * Constructs an <code>InterEduParseException</code> with a
     ...
     */
    InterEduParseException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message the detail message.
     */
    InterEduParseException(String message) {
        super(message);
    }
     ...
     * @see Exception#getCause()
     */
    InterEduParseException(Throwable cause) {
        super(cause);
    }
}
