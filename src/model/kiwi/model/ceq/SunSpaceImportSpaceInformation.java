 ...
 * @since 0.9
 */
@NamedQuery(name = "select.sunSpaceImportSpaceInformation", query = "SELECT sp_info  FROM SunSpaceImportSpaceInformation AS sp_info WHERE sp_info.spaceId=:spaceId")
@Entity
