...
public class ContentItemWriter implements MessageBodyWriter<ContentItem> {
	...
	public void writeTo(ContentItem st, Class<?> type, Type genericType,
	...
	public long getSize(ContentItem st, Class<?> type, Type genericType,
			Annotation[] annotations, MediaType mediatype) {
		return -1;
	}
