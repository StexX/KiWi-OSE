CREATE ALIAS calculate_equity_now AS $$
    ...
    @CODE 
    double compute(Connection conn, Date createTime, double equityValue, String actionType) {
        long createDate = createTime.getTime();
        long actionDate = new Date().getTime();
